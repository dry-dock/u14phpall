...
#Build PHP 7.2.9
echo "============ Building PHP 7.2.9 =============="
PHP_BUILD_CONFIGURE_OPTS="--with-bz2 --enable-intl" php-build -i development 7.2.9 $HOME/.phpenv/versions/7.2

# Setting phpenv to 7.2.9
...
mv phpunit-7.3.0.phar $HOME/.phpenv/versions/7.2/bin/phpunit
